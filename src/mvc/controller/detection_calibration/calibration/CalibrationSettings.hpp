...
/**
 * @brief Manages configuration paths and plugin settings for the Calibration Stage.
 *
 * This class extends CalibrationStageControllerSettings to provide specific handling for
 * board and sequence plugins.
 */
class CalibrationSettings : public CalibrationStageControllerSettings
{
public:
    //-----------------------------------------------------------------------------
    ...
    static inline const std::string CONFIG_DIR{ "Calibration" };
    static inline const std::string SETTINGS_FILE{ "calibration_settings.json" };
    static inline const std::string PARAMS_FILE{ "calibration_params.json" };
     ...
     * @param autoCalibOnNewDataset flag for auto calibration on new dataset.
